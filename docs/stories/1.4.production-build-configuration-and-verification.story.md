...
- Adjusted UI Layout:
    - Increased Graph height from 40vh to 55vh.
    - Reduced bottom padding for the "Start Monitoring" button container, and centralized the button.
    - Set final default Window dimensions to `1004x627` in `tauri.conf.json` based on user's input.
